...
function vboxGuestOSTypeIcon(osTypeId) {
    ...
    switch (osTypeId)
    {
		...
		// start this won't be seen in web interface without:
		// VirtualBox-7.0.14-update-ostype-support.patch into VirtualBox
		case "AlmaLinux":	strIcon = "os_alma.png"; break;
		case "AlmaLinux_64":	strIcon = "os_alma_64.png"; break;
		case "AmazonLinux":	strIcon = "os_amazon.png"; break;
		case "AmazonLinux_64":	strIcon = "os_amazon_64.png"; break;
		// end
		...
		case "Mageia_64":	strIcon = "os_mageia_64.png"; break;
